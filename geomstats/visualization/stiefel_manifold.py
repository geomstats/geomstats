...
class StiefelSphere:
    ...
    def set_view(self, elev=60.0, azim=0.0):
        ...
        elev : float, default: 60.0
          ...
          x-y plane, with a positive angle corresponding to a location above the plane.
    ...
    def coordinates_transformation(self, points):
        """Performs coordinate transformation on provided points.
...
class StiefelCircle:
    ...
    def plot_rendering(self, St_2, N):
        ...
        if St_2.p == 1:
            ...
            self.add_points(points)
            self.draw(self.ax, markersize=5, alpha=0.5, label="points")
