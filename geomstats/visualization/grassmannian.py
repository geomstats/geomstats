...
def projection_to_two_d(projections, points):
    """Apply projection matrix to a plotable 2D point.
...
def projection_to_three_d(projections, points):
    """Apply projection matrix to a plotable 3D point.
...
class Grassmannian:
    ...
    def plot(self, ticks):
        """Plot the Grassmannian manifold.
    ...
    def plot_rendering(self, ticks):
        """Plot Grassmanian manifold on random data.
