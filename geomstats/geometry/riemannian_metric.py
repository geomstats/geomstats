...
class RiemannianCometric(RiemannianMetric):
    ...
    def cometric_matrix(self, base_point=None):
        ...
        """
        raise NotImplementedError(
            "The computation of the cometric matrix" " is not implemented."
        )
    ...
    def inner_coproduct(self, covector_1, covector_2, base_point):
        ...
        inner_coproduct = gs.einsum("...i,...i->...", covector_1, vector_2)
    ...
    def exp(
        ...
        **kwargs
        ...
        flow, _ = integrate(
            self.hamiltonian_equation, initial_state, n_steps=n_steps, step=step
        )
