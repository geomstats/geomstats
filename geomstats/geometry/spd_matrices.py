...
class SPDMatrices(OpenSet):
    ...
    def projection(self, point):
        ...
        First the symmetric part of a point is computed, then the eigenvalues
    ...
    def random_tangent_vec(self, base_point, n_samples=1):
        ...
        -------
        samples : array-like, shape=[..., n, n]
            Points sampled in the tangent space at a base_point.
        """
        n = self.n
        size = (n_samples, n, n) if n_samples != 1 else (n, n)
    ...
    def cholesky_factor(cls, mat):
        ...
        Compute the cholesky factor for a symmetric positive
        definite matrix.
...
class SPDMetricAffine(RiemannianMetric):
    ...
    def inner_product(self, tangent_vec_a, tangent_vec_b, base_point):
        ...
        at a point base_point using the affine invariant Riemannian metric.
    ...
    def exp(self, tangent_vec, base_point, **kwargs):
        ...
        Compute the Riemannian exponential at a point base_point
    ...
    def parallel_transport(
        ...
        direction : array-like, shape=[..., n, n]
            Tangent vector at a base point, initial speed of the geodesic along
...
class SPDMetricBuresWasserstein(RiemannianMetric):
    ...
    def log(self, point, base_point, **kwargs):
        ...
        Compute the Riemannian logarithm at a point base_point,
        of a point wrt the Bures-Wasserstein metric.
        This gives a tangent vector at point base_point.
...
class SPDMetricEuclidean(RiemannianMetric):
    ...
    def inner_product(self, tangent_vec_a, tangent_vec_b, base_point):
        ...
        Compute the inner-product of tangent_vec_a and tangent_vec_b
        at a point base_point using the power-Euclidean metric.
    ...
    def log(self, point, base_point, **kwargs):
        ...
        Compute the Euclidean logarithm at a point base_point, of point.
        This gives a tangent vector at a point base_point.
...
class SPDMetricLogEuclidean(RiemannianMetric):
    ...
    def inner_product(self, tangent_vec_a, tangent_vec_b, base_point):
        ...
        Compute the inner-product of tangent_vec_a and tangent_vec_b
        at a point base_point using the log-Euclidean metric.
    ...
    def exp(self, tangent_vec, base_point, **kwargs):
        ...
        Compute the Riemannian exponential at a point base_point
        of a tangent vector tangent_vec wrt the Log-Euclidean metric.
        This gives a symmetric positive definite matrix.
    ...
    def log(self, point, base_point, **kwargs):
        ...
        Compute the Riemannian logarithm at a point base_point,
        of a point wrt the Log-Euclidean metric.
        This gives a tangent vector at point base_point.
