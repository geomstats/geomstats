"""The manifold of Laplacian matrices of rank k."""
...
class LaplaciansRankK(Manifold):
    """Class for the manifold of Laplacians with a given rank k.
    ...
    def belongs(self, mat, atol=gs.atol):
        """Check if a matrix is a Laplacian of a graph.
