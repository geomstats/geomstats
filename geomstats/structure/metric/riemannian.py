...
# from geomstats.spaces.equipped.symmetric_matrices import SymmetricMatrices
from geomstats.structure.connection import Connection
...
class RiemannianMetric(Connection, ABC):
    ...
    def __init__(self, space, signature=None, **kwargs):
    ...
    #
    #     pairwise_dist = SymmetricMatrices.from_vector(
    #         gs.array(out)
    #     )
