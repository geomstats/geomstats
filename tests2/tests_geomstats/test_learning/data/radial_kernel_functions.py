    ...
    def kernel_test_data(self):
        data = [
            ...
            dict(
                ...
                distance=gs.array([[1.0], [2]]),
                bandwidth=2.0,
                expected=gs.array([[9 / 16], [0]]),
            ),
            dict(
                kernel=triweight_radial_kernel,
                distance=gs.array([[1.0], [2]]),
                bandwidth=2.0,
                expected=gs.array([[(3 / 4) ** 3], [0]]),
            ),
            dict(
                kernel=tricube_radial_kernel,
                distance=gs.array([[1.0], [2]]),
                bandwidth=2.0,
                expected=gs.array([[(7 / 8) ** 3], [0]]),
            ),
            dict(
            ...
            dict(
                ...
                distance=gs.array([[1 / 2], [2.0]]),
                bandwidth=1.0,
                expected=gs.array([[gs.exp(-1 / (3 / 4))], [0]]),
            ),
            dict(
