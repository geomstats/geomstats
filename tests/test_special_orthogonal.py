...
class TestSpecialOrthogonal(geomstats.tests.TestCase):
    ...
    def test_is_tangent(self):
        ...
        result = self.group.is_tangent(vec_1, point, atol=gs.atol)
        expected = True
        self.assertAllClose(result, expected, atol=gs.atol)
        ...
        result = self.group.is_tangent(vec_2, point, atol=gs.atol)
        expected = False
        self.assertAllClose(result, expected, atol=gs.atol)
        ...
        expected = gs.array([True, False])
        result = self.group.is_tangent(vec, point, atol=gs.atol)
        self.assertAllClose(result, expected, atol=gs.atol)
