...
class TestMultinomialDistributions(tests.conftest.TestCase):
    ...
    def setup_method(self):
        ...
        self.dim = 3
        self.n_draws = 2
        self.multinomial = MultinomialDistributions(dim=self.dim, n_draws=self.n_draws)
        self.metric = MultinomialMetric(self.dim, n_draws=self.n_draws)
        self.n_points = 10
        self.n_samples = 20
    ...
    def test_random_point(self):
        ...
        """
        point = self.multinomial.random_point(self.n_points)
    ...
    def test_projection(self):
        ...
        projected_points = self.multinomial.projection(points)
    ...
    def test_to_tangent(self):
        ...
        projected_vectors = self.multinomial.to_tangent(vectors)
    ...
    def test_sample(self):
        ...
        """
        points = self.multinomial.random_point(self.n_points)
        samples = self.multinomial.sample(points, self.n_samples)
    ...
    def test_tangent_simplex_to_sphere_and_back(self):
        ...
        tangent_vec = self.multinomial.to_tangent(vec)
    ...
    def test_tangent_simplex_to_sphere_vectorization(self):
        ...
        """
        point = self.multinomial.random_point()
    ...
    def test_exp_and_log(self):
        ...
        Check that they are inverse.
        """
        base_points = self.multinomial.random_point(self.n_points)
        points = self.multinomial.random_point(self.n_points)
    ...
    def test_exp_and_log_vectorization(self):
        ...
        """
        base_point = self.multinomial.random_point()
        points = self.multinomial.random_point(self.n_points)
    ...
    def test_geodesic(self):
        ...
        """
        initial_point = self.multinomial.random_point()
        end_point = self.multinomial.random_point()
    ...
    def test_geodesic_vectorization(self):
        ...
        """
        initial_point = self.multinomial.random_point()
        vec = self.multinomial.random_point()
        initial_tangent_vec = self.multinomial.to_tangent(vec)
        ...
        n_vecs = 5
        n_times = 10
        vecs = self.multinomial.random_point(n_vecs)
        initial_tangent_vecs = self.multinomial.to_tangent(vecs)
        geod = self.metric.geodesic(
        ...
        end_points = self.multinomial.random_point(self.n_points)
