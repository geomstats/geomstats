...
class TestSphereMethods(unittest.TestCase):
    def test_riemannian_log_and_exp(self):
        ...
        riem_log_1 = sphere.riemannian_log(ref_point_1, point_1)
        result_1 = sphere.riemannian_exp(ref_point_1, riem_log_1)
        expected_1 = point_1
        ...
        riem_log_2 = sphere.riemannian_log(ref_point_2, point_2)
        result_2 = sphere.riemannian_exp(ref_point_2, riem_log_2)
        expected_2 = point_2
    ...
    def test_riemannian_dist(self):
        ...
        point_b_1 = point_a_1
        result_1 = sphere.riemannian_dist(point_a_1, point_b_1)
        expected_1 = 0.
        ...
        result_2 = sphere.riemannian_dist(point_a_2, point_b_2)
        expected_2 = np.pi / 2
