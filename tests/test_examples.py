...
import examples.plot_agglomerative_hierarchical_clustering_s2 as plot_agglomerative_hierarchical_clustering_s2 # NOQA
...
class TestExamples(geomstats.tests.TestCase):
    ...
    @geomstats.tests.np_only
    def test_plot_ahc_s2(self):
        plot_agglomerative_hierarchical_clustering_s2.main()
